		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-12">
				...
				<div class="col-xs-12 col-sm-6">
					...
					<p>
					<form method="get"
						action="${pageContext.request.contextPath}/shopCar/addToCar.action">
						<input type="hidden" name="id" value="${article.id}" /> <span
							...
							onclick="minuFun()">-</span> <input id="number" name="number"
							value="1" onblur="validNum(this)" style="width: 50px;" /> <span
							style="font-weight: bold; font-size: 18px; cursor: pointer; margin-left: 10px; margin-right: 10px;"
							onclick="addFun()">+</span>
						<button>

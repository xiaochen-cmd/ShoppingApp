...
<body>
	...
	<div class="container">
		...
		<div class="page-header" style="text-align: center;">
			<h1>用户登录</h1>
			&nbsp; <font color="red">${error_message}</font><font color="red">${message}</font>
		</div>
		<form class="form-horizontal" method="post"
			action="${pageContext.request.contextPath}/user/userLogin">
			<div class="form-group" style="width: 390px; margin: 10 auto;">
				<div class="col-sm-4">
					<input class="form-control" value="" placeholder="用户名/邮箱"
						type="text" id="loginName" name="loginName" style="width: 360px" />
				</div>
			</div>
			...
			<div class="form-group" style="width: 390px; margin: 10 auto;">
				<div class="col-sm-4">
					<input class="form-control" placeholder="密码" id="passWord"
						type="password" name="password" style="width: 360px" />
				</div>
			</div>
			<div class="form-group" style="width: 390px; margin: 10 auto;">
				<div class="col-sm-4">
